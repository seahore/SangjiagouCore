...
namespace SangjiagouCore
{
    ...
    /// </summary>
    public class War : IReportable<War.Report>
    {
        /// <summary>
        /// 义战结算
        /// </summary>
        ...
        protected int _initialAttackerArmy;
        /// <summary>
        /// 攻击方的初始兵力，宣战者出全部兵力，其他参战者出其20%兵力
        /// </summary>
        public int InitialAttackerArmy { get => _initialAttackerArmy; }
        ...
        protected int _initialDefenderArmy;
        /// <summary>
        /// 攻击方的初始兵力，被宣战者出全部兵力，其他参战者出其二成兵力
        /// </summary>
        public int InitialDefenderArmy { get => _initialDefenderArmy; }
        ...
        public War(State declarer, State declaree)
        {
            ...
            foreach (var s in _attackers) {
                _initialAttackerArmy += (int)(0.2f * s.Army);
            }
            _initialAttackerArmy += (int)(0.8f * Declarer.Army);

            _initialDefenderArmy = 0;
            foreach (var s in _defenders) {
                _initialDefenderArmy += (int)(0.2f * s.Army);
            }
            _initialDefenderArmy += (int)(0.8f * Declaree.Army);
        ...
        public void Settle()
        {
            ...
            _report = new War.Report(attackerWon, _initialAttackerArmy - attackerArmy, _initialDefenderArmy - defenderArmy);
        }

        public War.Report GetReport() => _report;
